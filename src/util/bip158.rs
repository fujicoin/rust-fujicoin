...
impl<'a> BlockFilterWriter<'a> {
    ...
    pub fn new(writer: &'a mut io::Write, block: &'a Block) -> BlockFilterWriter<'a> {
        let block_hash_as_int = block.fujicoin_hash().into_inner();
...
mod test {
    ...
    fn test_blockfilters() {
        ...
        for t in testdata.iter().skip(1) {
            ...
            assert_eq!(block.fujicoin_hash(), block_hash);
            ...
            let block_hash = &block.header.fujicoin_hash();
