...
//! Opcodes
//!
//! Fujicoin's script uses a stack-based assembly language. This module defines
//! all of the opcodes
//!
...
pub mod all {
    ...
    /// https://en.fujicoin.it/wiki/OP_CHECKSIG pushing 1/0 for success/failure
    pub const OP_CHECKSIG: All = All {code: 0xac};
    /// https://en.fujicoin.it/wiki/OP_CHECKSIG returning success/failure
    ...
    /// https://github.com/fujicoin/bips/blob/master/bip-0065.mediawiki
    pub const OP_CLTV: All = All {code: 0xb1};
    /// https://github.com/fujicoin/bips/blob/master/bip-0112.mediawiki
